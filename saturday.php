...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="saturday.php">Saturday</a></li>
...
if ($_SESSION["id"] == 1){
    ...
    echo "Tournaments Table Updated";
        ...
        $update1 = query("UPDATE tourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 24", $_POST["t1name"], $_POST["t1desc"], $pog1, $special1);
        $update2 = query("UPDATE tourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 25", $_POST["t2name"], $_POST["t2desc"], $pog2, $special2);
        $update3 = query("UPDATE tourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 26", $_POST["t3name"], $_POST["t3desc"], $pog3, $special3);
        $update4 = query("UPDATE tourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 27", $_POST["t4name"], $_POST["t4desc"], $pog4, $special4);
