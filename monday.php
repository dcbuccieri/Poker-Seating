...
if ($_SESSION["id"] == 1){
    ...
    echo "Tournaments Table Updated";
        ...
        $save = query("UPDATE seatingTourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 1", $_POST["t1name"], $_POST["t1desc"], $pog1, $special1);
        $save1 = query("UPDATE seatingTourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 2", $_POST["t2name"], $_POST["t2desc"], $pog2, $special2);
        $save2 = query("UPDATE seatingTourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 3", $_POST["t3name"], $_POST["t3desc"], $pog3, $special3);
        $save3 = query("UPDATE seatingTourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 4", $_POST["t4name"], $_POST["t4desc"], $pog4, $special4);
        $update1 = query("UPDATE seatingTourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 5", $_POST["t1name"], $_POST["t1desc"], $pog1, $special1);
        $update2 = query("UPDATE seatingTourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 6", $_POST["t2name"], $_POST["t2desc"], $pog2, $special2);
        $update3 = query("UPDATE seatingTourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 7", $_POST["t3name"], $_POST["t3desc"], $pog3, $special3);
        $update4 = query("UPDATE seatingTourneys SET `name` = ?, `descr` = ?, `pog` = ?, `special` = ? WHERE id = 8", $_POST["t4name"], $_POST["t4desc"], $pog4, $special4);
...
foreach ($q as $row){
    ...
    <div class='form-group'>
        ...
        <input type='text' class='form-control' name = 't".$c."desc' value='".$row['descr']."'>
    </div>
    <div class='checkbox'>
